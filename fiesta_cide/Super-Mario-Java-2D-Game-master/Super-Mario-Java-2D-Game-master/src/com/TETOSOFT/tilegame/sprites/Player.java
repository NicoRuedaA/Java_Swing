...
public class Player extends Creature {
    ...
    public void setDuckImage(Image image) {
        this.duckImage = image;
    }
    ...
    public void update(long elapsedTime) {
        ...
        // Flip horizontal: solo cambia cuando hay movimiento, mantiene ultima dir al
        // pararse
        if (getVelocityX() > 0) {
            facingRight = true;
            anim = getRightAnim();
